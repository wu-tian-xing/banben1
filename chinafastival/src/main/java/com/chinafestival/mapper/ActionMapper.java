...
public interface ActionMapper {
    ...
    //个人参加活动历史记录
    List<ActionView> selectUserAction(@Param("page")int page,@Param("limit")int limit,@Param("u_id")String u_id,@Param("statecode")int statecode);
    ...
    //报名接口
    int addUser_id(@Param("u_id")String u_id ,@Param("a_id")int a_id);


    //退出活动
    int outAction(@Param("a_id")int a_id,@Param("u_id")String u_id);
