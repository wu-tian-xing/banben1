...
public class DynamicServiceImpl implements DynamicService{
    ...
    @Override
    public List<DynamicView> qureyUserDynamic(int page, int limit, String user_id) {
        return  dynamicMapper.qureyUserDynamic(page, limit, user_id);
    }

    @Override
    public DynamicView selectOneDyname(int d_id) {
        return dynamicMapper.selectOneDyname(d_id);
    }
    ...
    @Override
    public List<DynamicView> selectDynamic(int page, int limit, String Keyword) {
