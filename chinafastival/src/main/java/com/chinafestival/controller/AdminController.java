...
public class AdminController {
    ...
    @ApiImplicitParams({
            @ApiImplicitParam(name = "a_id",value = "web用户账号",dataType = "int",required = true),
            @ApiImplicitParam(name = "password",value = "原密码",dataType = "String",required = true),
            @ApiImplicitParam(name = "pwd1",value = "新密码",dataType = "String",required = true),
            @ApiImplicitParam(name = "pwd2",value = "重复输入新密码",dataType = "String",required = true),
