...
public class ActionController {
    ...
    public JSONObject selectUserAction(@RequestParam("page")int page, @RequestParam("limit") int limit, @RequestParam("u_id") String u_id,@RequestParam("statecode")int statecode){
    ...
    public JSON addUser_id(String u_id ,int a_id){
    ...
    @ResponseBody
    @CrossOrigin
   public  JSON outAction(int a_id, String u_id){
