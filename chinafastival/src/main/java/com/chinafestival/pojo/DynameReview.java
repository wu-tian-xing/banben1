...
public class DynameReview {
  ...
  public DynameReview(int d_id, String details, String picture, String datetime, String user_id, int num_review, int praise, int r_id, String d_dateime, String d_details, String u_id) {
    this.d_id = d_id;
